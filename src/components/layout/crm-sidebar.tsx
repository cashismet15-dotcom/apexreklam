...
const menu = [
  { title: "Gelen Kutusu", href: "/musteri-takip", icon: Inbox },
  { title: "Ayarlar", href: "/musteri-takip/ayarlar", icon: Settings },
]
      ...
      <SidebarHeader className="px-3 py-4">
        <Link href="/" className="flex items-center gap-2 px-1">
          ...
          <div className="flex flex-col leading-none group-data-[collapsible=icon]:hidden">
            <span className="text-sm font-semibold">Müşteri Takip</span>
        ...
        <SidebarGroup>
          <SidebarGroupContent>
            <SidebarMenu>
              {menu.map((item) => {
                const active =
                  item.href === "/musteri-takip"
                    ? pathname === "/musteri-takip"
